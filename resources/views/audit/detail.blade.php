                                ...
                                @forelse ($data as $index => $item)
                                    <div class="tab-pane fade {{ $index == 0 ? 'show active' : '' }}" id="asset-{{ $index }}" role="tabpanel" aria-labelledby="asset-tab-{{ $index }}">
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <img src="{{ asset($item['assetDetailData']->img) }}" alt="Signature" class="img-fluid">
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <img src="{{ asset($item['assetDetailData']->signature) }}" alt="Signature" class="img-fluid">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="col-md-4 text-center">
                                            ...
                                            <!-- Rest of the asset details -->
                                            <!-- Your existing code for asset details goes here -->
                                        </div>
                                    </div>
                                @empty
