                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="signatureModalLabel">Input Signature</h5>
                                    ...
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            ...
                                            <button type="button" class="btn btn-danger mt-2" id="clearSignature">Clear</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                    ...
                                                    <strong>Remarks</strong><br>
                                                    <textarea name="Remarks[{{$item['assetHeaderData']->asset_no}}][]" id="" cols="30" rows="10"></textarea>
